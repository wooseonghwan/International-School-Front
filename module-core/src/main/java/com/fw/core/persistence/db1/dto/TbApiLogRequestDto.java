...
@Getter
@NoArgsConstructor
public class TbApiLogRequestDto {
    ...
    @Builder
    public TbApiLogRequestDto(String profile, String host, String url, String requestHeader, String errorLog, String parameter, String queryString, String requestBody, String result, String accessIp, Long processTime, LocalDateTime createDt) {
    ...
    public TbApiLog toEntity(){
        return TbApiLog.builder().profile(profile)
        					     .host(host)
        					     .url(url)
